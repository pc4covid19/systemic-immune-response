...
gcc -I"C:\Users\Michael Getz\libroadrunner\roadrunner-win64-vs14-cp35m\include\rr\C" test_v4.c -L"C:\Users\Michael Getz\libroadrunner\roadrunner-win64-vs14-cp35m\lib" -lroadrunner_c_api -o testv4
*/
#undef __cplusplus
#define STATIC_RRC
#include <stdio.h>
...
int main (int argc, char *argv[]) 
{
   ...
   if (!loadSBML (rrHandle, "immune_response.xml")) 
   {
